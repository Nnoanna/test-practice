...
function averageOfFour(num1, num2, num3, num4) {
    ...
    the numbers. */
    // Your code here
    let fourAverage = (num1 + num2 + num3 + num4) / 4;
    return fourAverage;
};
...
function isSubString(searchString, subString) {
    ...
    // Your code here
    let downSearch = searchString.toLowerCase();
    let downSub = subString.toLowerCase();
    if (downSearch.indexOf(downSub) != -1) {
        return true;
    }
    else {
        return false;
